...
y_test_pred_no_regularization = reg_no_regularization.predict(X_test)
mse_test_no_regularization = mean_squared_error(y_test_pred_no_regularization, y_test)
print(mse_test_no_regularization)
...
for log_lambda in range(-10, 11, 1):
    ...
    # test
    y_test_pred_l1 = reg_l1.predict(X_test)
    mse_test_l1 = mean_squared_error(y_test_pred_l1, y_test)

    print(mse_l1, mse_test_l1, reg_l1.coef_)
    ...
    # test
    y_test_pred_l2 = reg_l2.predict(X_test)
    mse_test_l2 = mean_squared_error(y_test_pred_l2, y_test)

    print("lambda: ", cur_lambda,  " mse (l1): ", mse_l1, " mse (l2): ", mse_l2)
    print("test lambda: ", cur_lambda,  " mse (l1): ", mse_test_l1, " mse (l2): ", mse_test_l2)
...
for i in range(1, 101, 100):
    ...
    # test
    y_test_pred_RANSAC = reg_RANSAC.predict(X_test)
    mse_test_RANSAC = mean_squared_error(y_test_pred_RANSAC, y_test)

    print(mse_RANSAC, mse_test_RANSAC)
